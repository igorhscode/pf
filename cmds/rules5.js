...
module.exports.run = async (bot,message,args) => {
    ...
    › Увидели как нарушают участники или еще хуже Администраторы? Вы обязаны подать на них жалобу Главной Администрации, для этого пропишите команду _**pf!report <@участник> причина**_. Так же прикладывайте доказательства после написания причины, нам будет легче разобраться с нарушителем. 
